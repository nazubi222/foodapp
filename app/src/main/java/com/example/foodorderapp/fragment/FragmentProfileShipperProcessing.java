...
public class FragmentProfileShipperProcessing extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_profile_shipper_processing, container, false);
        initUI();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.imgshipperbillprocessing_back).setOnClickListener(v -> {
            navController.navigateUp();
        });
    }

    private void initUI() {
        recyclerView = mView.findViewById(R.id.rcv_shipperprocessing);
        ...
        foodCartStatusAdapter = new FoodCartStatusAdapter(listBill, getActivity(), new FoodCartStatusAdapter.IClickItemFoodCartStatus() {
            ...
            public void onClickItemFoodCartStatus(BillFood billFood) {
                ...
                navController.navigate(R.id.action_fragmentProfileShipperProcessing_to_fragmentProfileShipperBillFood, bundle);
            }
        });
